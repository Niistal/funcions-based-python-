...
def Preguntadosbutrandomized():
    ...
    qentertainment = ["Who is the main character in the pokemon series?",
    ...
    qhistory = ["¿Who discovered America?", " ¿In which year finished World War 2",
                "¿In which country was born Hitler?"]
    ahistory = ["cristobal colon", "1945", "austria"]
    qsport = ["¿which country won the world cup in 2022? ", "¿who is the the player who scored more points in the NBA?",
              "¿Who is the fastest athlete in the history?"]
    asport = ["argentina", "lebron james", "usain bolt"]
    qgeography = ["¿which is the country with the highest population?", "¿which is the highest mountain in the world?",
                  "which is the capital of the USA "]
    ageography = ["tokio", "everest", "washington"]
    name = str(input("Enter your name please:"))
    score = 0
    print(
        "Hello " + name + " today you are gonna play a little quiz and you can't choose anything,you will only answer to five questions that are chosen randomly (the answers must be in lowercase)")
...
def NistalMain(score):
    ...
    while num != 6:
        ...
        print(
            "Hello " + name + " you are gonna play a quiz and you have a few topics and to win you have to answer the questions as fast as you can\n")
